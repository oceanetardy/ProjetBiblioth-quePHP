...
<header>
    ...
    <div class="auth-buttons">
        <?php if ($utilisateurConnecte) : ?>
            ...
            <?php else : ?>
                <a href="views/liste_livres_utilisateurs.php" class="button" <?php if ($estSurPageMesLivres || $estSurPageMyInfos || $estSurPageAllLivres || $estSurPageAllComment || $estSurPageAllLivresAdmin || $estSurPageSearchLivre) echo 'style="display:none;"'; ?>>Mes Livres</a>
            <?php endif; ?>

            <!-- Ajoutez le lien "Mes Infos" -->
            <a href="views/modifier_infos.php" class="button" <?php if ($estSurPageMesLivres || $estSurPageMyInfos || $estSurPageAllLivres || $estSurPageAllComment || $estSurPageAllLivresAdmin || $estSurPageSearchLivre) echo 'style="display:none;"'; ?>>Mes Infos</a>
